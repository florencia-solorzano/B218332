...
```{r}
daylight_north_scot <- read_table("docs/data/R_north_scotland_sunshine.csv")

daylight_east_scot <- read_table("docs/data/R_east_scotland_sunshine.csv")

daylight_west_scot <- read_table("docs/data/R_west_scotland_sunshine.csv")
```
